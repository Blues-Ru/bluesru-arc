#!/usr/bin/env python3
"""
Test server for blues-arc generated site/.

Usage:
  python3 blues-arc/scripts/serve.py [--port 8000] [--site /path/to/site]

Features:
  - Serves site/ directory
  - Resolves directory requests to index.html
  - Correct Content-Type: text/html; charset=utf-8 for HTML
  - Parses blues-arc/_redirects for 301/302 redirect rules (path-only, no query string)
  - Rewrites /forum/topicN → /forum/topicN.html (no extension → add .html)

Run from /Users/fedor/bluesru/:
  python3 blues-arc/scripts/serve.py
"""
